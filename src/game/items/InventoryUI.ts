...
import { InventorySlot, Item } from './InventorySystem';
...
export class InventoryUI {
     ...
     */
    public reset(): void {
        // Clear all items and request fresh inventory state
        if (this.qItemSprite) {
            this.qItemSprite.destroy();
            this.qItemSprite = null;
        }
        ...
        this.qChargeText.setVisible(false);
        this.eChargeText.setVisible(false);
        
        // Request fresh inventory state
        EventBus.emit('get-inventory');
    }
